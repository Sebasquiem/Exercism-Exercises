...
def approx_average_is_average(hand):
    ...
    calculated_average = card_average([hand[0],hand[-1]])
    median_index = (len(hand) - 1) / 2
    median = card_average([hand[math.floor(median_index)], hand[math.ceil(median_index)]])
    return true_average == median or true_average == calculated_average
