...
def compare_records(azara_record, rui_record):
    ...
    """
    return azara_record[1] == rui_record[1][0] + str(rui_record[1][1])
...
def create_record(azara_record, rui_record):
    ...
    """
    if azara_record[1] == rui_record[1][0] + str(rui_record[1][1]):
...
def clean_up(combined_record_group):
    ...
    for record in combined_record_group:
        ...
        report.append(clean_record)
    return "\n".join(str(record) for record in report) + "\n"
